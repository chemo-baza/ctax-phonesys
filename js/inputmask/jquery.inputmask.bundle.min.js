        ...
        function u(r, s, c) {
            function d(e, t, n) {
                ...
                var a, r, o, s = [],
                    ...
                    u = v();
                do {
                    !0 === e && h().validPositions[l] ? (r = (o = h().validPositions[l]).match, a = o.locator.slice(), s.push(!0 === n ? o.input : !1 === n ? r.nativeDef : N(l, r))) : (r = (o = b(l, a, l - 1)).match, a = o.locator.slice(), (!1 === c.jitMasking || l < u || "number" == typeof c.jitMasking && isFinite(c.jitMasking) && c.jitMasking > l) && s.push(!1 === n ? r.nativeDef : N(l, r))), 1 == c.keepStatic && r.newBlockMarker && null !== r.fn && (c.keepStatic = l - 1), l++
                } while ((W === i || l < W) && (null !== r.fn || "" !== r.def) || t > l);
            ...
            function U(e, t, a) {
                ...
                if ($ !== i) {
                    ...
                    if (t === i ? t = B(e) : t.begin === i && (t = {
                        ...
                        var d = v();
                        do {
                            h().validPositions[f] ? (s = h().validPositions[f], o = s.match, l = s.locator.slice(), r(m[f])) : (s = b(f, l, f - 1), o = s.match, l = s.locator.slice(), (!1 === c.jitMasking || f < d || "number" == typeof c.jitMasking && isFinite(c.jitMasking) && c.jitMasking > f) && r(N(f, o))), f++
                        } while ((W === i || f < W) && (null !== o.fn || "" !== o.def) || d > f || p);
            ...
            if (r !== i) switch (r.action) {
                ...
                case "remove":
                    if (Z && Z.inputmask) {
                        Q = e(Z), Z.inputmask._valueSet(c.autoUnmask ? G(Z) : Z.inputmask._valueGet(!0)), ie.off(Z), Z.inputmask.colorMask && (($ = Z.inputmask.colorMask).removeChild(Z), $.parentNode.insertBefore(Z, $), $.parentNode.removeChild($));
                        Object.getOwnPropertyDescriptor && Object.getPrototypeOf ? Object.getOwnPropertyDescriptor(Object.getPrototypeOf(Z), "value") && Z.inputmask.__valueGet && Object.defineProperty(Z, "value", {
                            ...
                            configurable: !0
                        }) : n.__lookupGetter__ && Z.__lookupGetter__("value") && Z.inputmask.__valueGet && (Z.__defineGetter__("value", Z.inputmask.__valueGet), Z.__defineSetter__("value", Z.inputmask.__valueSet)), Z.inputmask = i
                    }
                    return Z;
                case "getmetadata":
