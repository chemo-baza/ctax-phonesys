    ...
    $.extend($.fn, {
        miniColors: function(o, data) {
            ...
            var show = function(input) {
                ...
                selector.append('<div class="miniColors-colors" style="background-color: #FFF;"><div class="miniColors-colorPicker"></div></div>').append('<div class="miniColors-hues"><div class="miniColors-huePicker"></div></div>').css({
            ...
            var hide = function(input) {
                ...
                $(document).unbind('mousedown.miniColors touchstart.miniColors').unbind('mousemove.miniColors touchmove.miniColors')
            };
