...
var $buo = function(op, test) {
    ...
    //console.log(!this.op.browser,!this.op.browser.n,this.op.browser.n=="x",this.op.browser.donotnotify!==false,(document.cookie.indexOf("browserupdateorg=pause")>-1 && this.op.reminder>0),this.op.browser.v>this.op.vs[this.op.browser.n],this.op.browser.v, this.op.vs[this.op.browser.n], this.op.reminder, document.cookie.indexOf("browserupdateorg=pause"));
...
background:#3178B8 no-repeat 13px center;\
